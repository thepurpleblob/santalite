...
CREATE TABLE `purchase` (
  ...
  `cardtype` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `last4digits` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `bankauthcode` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `declinecode` text COLLATE utf8_unicode_ci DEFAULT NULL,
